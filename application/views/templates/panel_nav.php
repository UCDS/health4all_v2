...
.sousMenu ul
{
	...
	<li <?php if(current_url()==base_url()."bloodbank/register/donation"){ echo "class='active'";}?>><div data-toggle="popover" data-placement="bottom" data-content="Donor Medical Checkup"><a href="<?php echo base_url();?>bloodbank/register/donation"><i class="fa fa-stethoscope " style="color:#E84F4F"></i>Step <strong style="color:#E84F4F">3</strong>: Donor Checkup</a></div></li>
