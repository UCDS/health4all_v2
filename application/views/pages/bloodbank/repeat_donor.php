		...
		<div class="row" style="border:1px solid #dddddd;">
			...
			<div class="panel-body" style="color:black;">
				...
				<p>
					...
					<label for="donor_id">Donor ID </label> <input class="form-control" type="text" value="<?php echo htmlentities($this->input->post('donor_id')); ?>" name="donor_id" id="donor_id"/>
					<label for="donor_name">Donor Name </label> <input class="form-control" type="text" name="donor_name" id="donor_name" value="<?php echo htmlentities($this->input->post('donor_name'))?>"/>
					<label for="donor_email">Email </label> <input class="form-control" type="text" value="<?php echo htmlentities($this->input->post('donor_email')); ?>" name="donor_email" id="donor_email"/>
					
				</p>
				<p>
					<label for="donor_mobile">Mobile Number </label> <input class="form-control" type="text" value="<?php echo htmlentities($this->input->post('donor_mobile')); ?>" name="donor_mobile" id="donor_mobile"/>
