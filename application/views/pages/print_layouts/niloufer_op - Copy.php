		...
		<table style="width:98%;padding:5px">
				<tr>
				<td colspan="3">
				<img style="float:right" style="margin-top:-20px" src="<?php echo base_url();?>assets/images/andhra-logo.jpg" width="60px" />
				...
				<tr class="print-element" width="95%" height="130px">
					<td colspan="2">
						Examination:
					</td>
