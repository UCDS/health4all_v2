									...
									<div class="form-group">
										<label for="inputhospital_id" >Hospital</label>
											<select name="hospital_id" id="department" class="form-control">
												<option value="Hospital_id">select</option>
													<?php 
																					  ...
																					  <div class="container">
																							...
																							<div class="form-group">
																								...
																								<label class="checkbox-inline">
                                                                                                  <input name="radio" type="checkbox" value="1"> mon
                                                                                                       </label>
                                                                                                  <label class="checkbox-inline">
                                                                                               <input name="radio" type="checkbox"  value="1"> tue
                                                                                                    </label>
                                                                                              <label class="checkbox-inline">
                                                                                                   <input name="radio" type="checkbox"  value="1">wed
                                                                                                             </label>
                                                                                                      <label class="checkbox-inline">
                                                                                               <input name="radio" type="checkbox"  value="1"> thr
                                                                                                   </label>
																								   <label class="checkbox-inline">
                                                                                                   <input name="radio" type="checkbox"  value="1">fri
                                                                                                             </label>
                                                                                                      <label class="checkbox-inline">
                                                                                               <input name="radio" type="checkbox"  value="1"> sat
                                                                                                   </label>
