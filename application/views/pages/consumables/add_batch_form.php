...
$(function(){
	...
	$("#probable_date_of_completion,#agreement_completion_date").Zebra_DatePicker({
		...
		<h3>Add Batch Details</h3></center><br>
	<center><?php echo validation_errors(); echo form_open('masters/add/batch',array('role'=>'form')); ?></center>
	<div class="form-group">
		<label for="item" class="col-md-4"> Batch Number<font color='red'>*</font></label>
		<div  class="col-md-8">
		<input type="text" class="form-control" placeholder="Batch Number" id="dosage" name="batch_number" />
		</div>
	</div>
	...
	<div class="form-group">
		<label for="item_quantity" class="col-md-4">Item Quantity<label>
		<div  class="col-md-8">
		<input type="text" class="form-control" placeholder="Item quantity" id="item_quantity" name="item_quantity" />
		</div>
	</div>
	<!--<div class="form-group">
