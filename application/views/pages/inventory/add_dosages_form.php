...
$(function(){
	...
	<center><?php echo validation_errors(); echo form_open('masters/add/dosages',array('role'=>'form')); ?></center>
	...
	<div class="form-group">
		<label for="dosage_unit" class="col-md-4"> Dosage Unit<font color='red'>*</font></label>
		<div  class="col-md-8">
