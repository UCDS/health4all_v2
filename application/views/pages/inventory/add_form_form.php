...
$(function(){
	...
	$("#probable_date_of_completion,#agreement_completion_date").Zebra_DatePicker({
		...
		<h3>Add Form Details</h3></center><br>
	<center><?php echo validation_errors(); echo form_open('masters/add/form',array('role'=>'form')); ?></center>
	<div class="form-group">
		<label for="item" class="col-md-4"> Form Name<font color='red'>*</font></label>
		<div  class="col-md-8">
		<input type="text" class="form-control" placeholder=" Form Name" id="dosage" name="form_name" />
		</div>
	</div>
