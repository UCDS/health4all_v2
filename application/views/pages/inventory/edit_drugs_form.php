	...
	<?php echo form_open('masters/edit/drugs',array('role'=>'form')); ?>
...
<!--
	...
	<div class="col-md-12">
	<?php echo form_open('masters/edit/drugs',array('role'=>'form','id'=>'search_form','class'=>'form-inline','name'=>'search_drugs'));?>
	...
	$i=1;
	foreach($drug as $a){ ?>
	<?php echo form_open('masters/edit/drugs',array('id'=>'select_drug_form_'.$a->drug_type_id,'role'=>'form')); ?>
