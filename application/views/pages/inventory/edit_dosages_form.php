	...
	<?php echo form_open('masters/edit/dosages',array('role'=>'form')); ?>
...
<!--
	...
	<div class="col-md-12">
	<?php echo form_open('masters/edit/dosages',array('role'=>'form','id'=>'search_form','class'=>'form-inline','name'=>'search_dosages'));?>
	...
	$i=1;
	foreach($dosage as $a){ ?>
	<?php echo form_open('masters/edit/dosages',array('id'=>'select_dosages_form_'.$a->dosage_id,'role'=>'form')); ?>
