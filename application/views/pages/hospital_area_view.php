    ...
    <div class="col-md-8 col-md-offset-3">
	 <div class="row">
		<div class="col-xs-12 col-sm-12 col-md-6 col-lg-4">
			...
			<input class="form-control" name="area_name"  id="inputarea_name" placeholder="Area Name" type="TEXT" align="middle">
			</div>
		</div>
		<div class = "col-xs-12 col-sm-12 col-md-6 col-lg-4">
			<div class="form-group">
	   ...
	   <div class="form-group">
	    <label for="inputdepartment_id">Department</label>
	     ...
	     <?php
		  ...
		  {
		    echo "<option value='".$dept->department_id."' class='".$dept->hospital_id."'>".$dept->department."</option>";
		  }
		 ?>
		</select>
	   </div>	
	  ...
	  <div class="col-xs-12 col-sm-12 col-md-6  col-lg-4">
	    <div class="form-group">
			...
			<input class="form-control" name="beds" id="beds" placeholder="Beds(If any)" type="text">
	    </div>
	  </div>
	  <div class="col-xs-12 col-sm-12 col-md-6 col-lg-4">
	   <div class="form-group">
